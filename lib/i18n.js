...
const UI_TEXT = {
  en: {
    ...
    assessment: {
      intro: 'Welcome. We will go through three levels of questions: Remember, Understand, and Apply. Each question is grounded in the two stories you prepared. You may listen to each question and answer by voice or text.',
      levelIntros: {
        remember: {
      ...
      moveToLevel: (title, desc) => `Now moving to ${title}. ${desc}`,
      questionPrefix: (current, total) => `Question ${current} of ${total}. `,
      complete: 'Complete',
      ...
      typeAnswerPlaceholder: 'Type your answer here... (Enter to submit)',
      finalQuestionDone: ' That was the final question. Well done for completing the assessment.',
      continueNext: ' Thank you. We will continue with the next question.',
      thankYouAnswer: 'Thank you for your answer.',
      finishFallback: 'Thank you for completing the assessment. Your results will be reviewed by the admissions team.',
    ...
    api: {
      evaluationStudentFallback: 'Thank you for your answer.',
  ...
  pt: {
    appName: 'Avaliação de Prontidão para Graduação',
    appNameShort: 'Avaliação de Prontidão para Graduação',
    description: 'Avaliação de prontidão para graduação da University of the Nations',
    universityLabel: 'University of the Nations - YWAM',
    ...
    assessment: {
      intro: 'Bem-vindo(a). Vamos passar por três níveis de perguntas: Lembrar, Compreender e Aplicar. Cada pergunta é baseada nas duas histórias que você estudou. Você pode ouvir cada pergunta e responder por voz ou por texto.',
      levelIntros: {
        remember: {
          title: 'Nível 1 - Lembrar',
          desc: 'Perguntas sobre o que aconteceu na História A.',
        },
        understand: {
          title: 'Nível 2 - Compreender',
          desc: 'Perguntas sobre significado e interpretação na História A.',
        },
        apply: {
          title: 'Nível 3 - Aplicar',
          desc: 'Perguntas que conectam as duas histórias.',
        },
      },
      moveToLevel: (title, desc) => `Agora vamos para ${title}. ${desc}`,
      questionPrefix: (current, total) => `Pergunta ${current} de ${total}. `,
      complete: 'Concluída',
      assessmentComplete: 'AVALIAÇÃO CONCLUÍDA',
      resultsReviewed: 'Seus resultados serão analisados pela equipe de admissões. Obrigado(a) pelo seu tempo.',
      ...
      typeAnswerPlaceholder: 'Digite sua resposta aqui... (Enter para enviar)',
      finalQuestionDone: ' Essa foi a última pergunta. Muito bem por concluir a avaliação.',
      continueNext: ' Obrigado(a). Vamos continuar com a próxima pergunta.',
      thankYouAnswer: 'Obrigado(a) pela sua resposta.',
      finishFallback: 'Obrigado(a) por concluir a avaliação. Seus resultados serão analisados pela equipe de admissões.',
      questionCounter: (current, total) => `P${current}/${total}`,
    },
    admin: {
      accessTitle: 'Acesso do administrador',
      dashboardTitle: 'Painel da Avaliação de Prontidão para Graduação',
    ...
    api: {
      evaluationStudentFallback: 'Obrigado(a) pela sua resposta.',
      evaluationAdminFallback: 'Falha ao interpretar a avaliação.',
      reportStudentFallback: 'Obrigado(a) por concluir a avaliação. Seus resultados serão analisados pela equipe de admissões.',
