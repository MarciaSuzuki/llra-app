...
const UI_TEXT = {
  en: {
    ...
    assessment: {
      intro: 'Welcome, and thank you for being here. We will go through three levels of questions: Remember, Understand, and Apply. Each question is grounded in the two stories you prepared. You may listen to each question and answer by voice or text.',
      levelIntros: {
        remember: {
      ...
      continueNext: ' We will continue with the next question.',
  ...
  pt: {
    ...
    assessment: {
      intro: 'Olá. Obrigado por estar aqui. Vamos passar por três níveis de perguntas: Lembrar, Compreender e Aplicar. Cada pergunta é baseada nas duas histórias que você estudou. Você pode ouvir cada pergunta e responder por voz ou por texto.',
      levelIntros: {
        remember: {
      ...
      continueNext: ' Vamos continuar com a próxima pergunta.',
      thankYouAnswer: 'Certo.',
      finishFallback: 'Obrigado por concluir a avaliação. Seus resultados serão analisados pela equipe de admissões.',
